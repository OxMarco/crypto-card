...
contract PRBTestMock is PRBTest {
    ...
    function _assertEq(bool[] memory a, bool[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertEq(a, b, err);
    ...
    function _assertEq(bytes32[] memory a, bytes32[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertEq(a, b, err);
    ...
    function _assertEq(string memory a, string memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertEq(a, b, err);
    ...
    function _assertNotEq(address a, address b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(address[] memory a, address[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(bool[] memory a, bool[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(bytes memory a, bytes memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(bytes32[] memory a, bytes32[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(int256[] memory a, int256[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(string memory a, string memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(uint256 a, uint256 b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertNotEq(uint256[] memory a, uint256[] memory b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertNotEq(a, b, err);
    ...
    function _assertAlmostEq(int256 a, int256 b, uint256 maxDelta, bool expectFail)
        external
        expectFailure(expectFail)
    {
    ...
    function _assertAlmostEq(int256 a, int256 b, uint256 maxDelta, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
    ...
    function _assertAlmostEq(uint256 a, uint256 b, uint256 maxDelta, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertAlmostEq(a, b, maxDelta);
    ...
    function _assertAlmostEq(uint256 a, uint256 b, uint256 maxDelta, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertAlmostEq(a, b, maxDelta, err);
    ...
    function _assertContains(address[] memory a, address b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
    ...
    function _assertContains(bytes32[] memory a, bytes32 b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertContains(a, b, err);
    ...
    function _assertContains(int256[] memory a, int256 b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertContains(a, b, err);
    ...
    function _assertContains(uint256[] memory a, uint256 b, string memory err, bool expectFail)
        external
        expectFailure(expectFail)
    {
        assertContains(a, b, err);
