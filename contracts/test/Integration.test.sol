...
contract IntegrationTest is PRBTest, StdCheats {
    ...
    constructor() {
        ...
        vault2 = new Vault(1, address(accountant), 0, address(router));
    ...
    function testDepositWithdraw(uint256 amount1, uint256 amount2) public {
        vm.assume(amount2 < type(uint256).max - amount1);
    ...
    function testDepositWithdrawWithFee(uint256 amount1, uint256 amount2) public {
        ...
        testDepositWithdraw(amount1, amount2);
    }
